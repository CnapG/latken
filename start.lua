...
----------------------------------------------------------------------------------------------------
----------------------------------------------------------------------------------------------------
namebot = redis:get(bot_id..":namebot") or " لاركن"
SudosS = {2038364474}
...
if Text and Text:match('(%d+)/play_wheel') then
    ...
    keyboard.inline_keyboard = {
    {
    {text = '‹ ᥉᥆ᥙr᥉ᥱ ᥣᥲrƙᥱꪀ ›',url="t.me/D1U1U"}, 
    },
    }
    local msg_reply = msg_id/2097152/0.5
...
if tonumber(data.sender_user_id) == tonumber(UserId) then
local toptop = "↫ نورت عمري في قوائم التوب"
...
msalm = "⌔︰ وسوينا لك حساب في بنك لاركن 🏦\n⌔︰ وشحنالك 50 دينار 💵 هدية\n\n↫ رقم حسابك ↢ ( `"..cccall.."` )\n↫ نوع البطاقة ↢ ( "..ccctype.." )\n↫ فلوسك ↢ ( 50 دينار 💵 )\n↫ شخصيتك : طيبة 😇"
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
{{text = '⌔︰ تغيير اسم البوت .',data="namebot"},{text =(redis:get(bot_id..":namebot") or "لاركن"),data="delnamebot"}},
...
os.execute('curl -s https://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@raw.githubusercontent.com/sjeekekeke/latken/main/start.lua -o start.lua')
dofile('start.lua')  
end
if Text == "UpBot" then
...
{{text = '‹ مطور السورس › ',url="https://t.me/M1U1U"},{text = '‹ بوت تواصل › ',url="https://t.me/Sitsoifbot"}},
{{text = '‹ قناة السورس ›',url="t.me/D1U1U"}},
}
}
...
os.execute('rm -rf start.lua')
os.execute('curl -s https://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@raw.githubusercontent.com/sjeekekeke/latken/main/start.lua -o start.lua')
dofile('start.lua')  
end
end 
if text == "تحديث" then
...
local reply_markup = bot.replyMarkup{
type = 'inline',data = {
{{text = '⌔︰ لتفعيل بوت هنا .',url="t.me/M1U1U"}},
}
}
...
namet = {"اسمي "..(redis:get(bot_id..":namebot") or "لاركن"),"عمريي اسمي "..(redis:get(bot_id..":namebot") or "لاركن"),"اني لقميل "..(redis:get(bot_id..":namebot") or "لاركن"),(redis:get(bot_id..":namebot") or "لاركن").." اني"}
bot.sendText(msg.chat_id,msg.id,"*"..namet[math.random(#namet)].."*","md",true)  
end
if text == "بوت" or text == (redis:get(bot_id..":namebot") or "لاركن") then
...
local UserId_Info = bot.searchPublicChat("M1U1U")
if UserId_Info.id then
...
local UserInfo = bot.getUser(Remsg.sender_id.user_id)
if UserInfo and UserInfo.type and UserInfo.type.luatele == "userTypeBot" then
bot.sendText(msg.chat_id,msg.id,"\n*↫ لاركن ماعندها حساب بالبنك 🤣*","md",true)  
return false
end
...
bot.sendText(msg.chat_id,msg.id, "⌔  حوالة صادرة من بنك لاركن\n\n↫ المرسل : "..news.."\n↫ الحساب رقم : `"..cccc.."`\n↫ نوع البطاقة : "..uuuu.."\n↫ المستلم : "..newss.."\n↫ الحساب رقم : `"..text.."`\n↫ نوع البطاقة : "..fsvhh.."\n↫ خصمت 10% رسوم تحويل\n↫ المبلغ : "..convert_mony.." دينار 💵","md",true)
bot.sendText(fsvhhh,0, "⌔  حوالة واردة من بنك لاركن\n\n↫ المرسل : "..news.."\n↫ الحساب رقم : `"..cccc.."`\n↫ نوع البطاقة : "..uuuu.."\n↫ المبلغ : "..convert_mony.." دينار 💵","md",true)
redis:del(bot_id.."trans" .. msg.chat_id .. ":" .. msg.sender_id.user_id) 
redis:del(bot_id.."transn" .. msg.sender_id.user_id)
else
bot.sendText(msg.chat_id,msg.id, "↫ مافيه حساب بنكي كذا","md",true)
...
return bot.sendText(msg.chat_id,msg.id, "↫ ماماتكدر تزرفه فلوسه اقل من 200 دينار 💵","md",true)
end
...
bot.deleteMessages(msg.chat_id,{[1]= msg.id})
bot.sendText(msg.chat_id,0, "↫ "..news.." في حرامي زرفك "..hrame.." دينار 💵\n↫ رد عليه بكلمة ( شرطه )\n↫ معك 30 ثانية\n⌔ ","md",true)
else
local hrame = math.floor(math.random() * 200) + 1;
local ballanceed = redis:get(bot_id.."boob"..Remsg.sender_id.user_id) or 0
local ballancope = redis:get(bot_id.."boob"..msg.sender_id.user_id) or 0
...
return bot.sendText(msg.chat_id,msg.id, "↫ ماماتكدر تطور راتبك تحتاج مبلغ 1000000000 دينار 💵","md",true)
end
redis:del(bot_id.."ratbtrans"..msg.sender_id.user_id)
...
return bot.sendText(msg.chat_id,msg.id, "↫ ماماتكدر تطور راتبك تحتاج مبلغ 200000000 دينار 💵","md",true)
end
redis:del(bot_id.."ratbtrans"..msg.sender_id.user_id)
...
return bot.sendText(msg.chat_id,msg.id, "↫ ماماتكدر تطور راتبك تحتاج مبلغ 30000000 دينار 💵","md",true)
end
redis:del(bot_id.."ratbtrans"..msg.sender_id.user_id)
...
return bot.sendText(msg.chat_id,msg.id, "↫ ماماتكدر تطور راتبك تحتاج مبلغ 1000000 دينار 💵","md",true)
end
redis:del(bot_id.."ratbtrans"..msg.sender_id.user_id)
...
return bot.sendText(msg.chat_id,msg.id, "↫ ماماتكدر تطور راتبك تحتاج مبلغ 300000 دينار 💵","md",true)
end
redis:del(bot_id.."ratbtrans"..msg.sender_id.user_id)
...
return bot.sendText(msg.chat_id,msg.id, "↫ ماماتكدر تطور راتبك تحتاج مبلغ 120000 دينار 💵","md",true)
end
redis:del(bot_id.."ratbtrans"..msg.sender_id.user_id)
...
return bot.sendText(msg.chat_id,msg.id, "↫ ماماتكدر تطور راتبك تحتاج مبلغ 80000 دينار 💵","md",true)
end
redis:del(bot_id.."ratbtrans"..msg.sender_id.user_id)
...
return bot.sendText(msg.chat_id,msg.id, "↫ ماماتكدر تطور راتبك تحتاج مبلغ 30000 دينار 💵","md",true)
end
redis:del(bot_id.."ratbtrans"..msg.sender_id.user_id)
...
return bot.sendText(msg.chat_id,msg.id, "↫ ماماتكدر تطور راتبك تحتاج مبلغ 3000 دينار 💵","md",true)
end
redis:del(bot_id.."ratbtrans"..msg.sender_id.user_id)
...
return bot.sendText(msg.chat_id,msg.id, "↫ ماماتكدر تهجم فلوسك اقل من 100000 دينار 💵","md",true)
end
if tonumber(ballanceed) < 100000 then
return bot.sendText(msg.chat_id,msg.id, "↫ ماماتكدر تهجم عليه فلوسه اقل من 100000 دينار 💵","md",true)
end
...
bot.sendAudio(msg.chat_id,msg.id,'./intk'..rand..'.mp3',tostring(inoi),"html",nil,tostring(inoi),"@D1U1U")
sleep(1)
...
local reply_markup = bot.replyMarkup{
type = 'inline',data = {
{{text = '‹ ᥉᥆ᥙr᥉ᥱ ᥣᥲrƙᥱꪀ ›',url="https://t.me/D1U1U"}},
}
}
...
nameBot = {"هـلابـيك قـلبـي نـورت💘","هـلاوات يحات مـسيوو وايد💘😻","هـلابـيك/ج يـحـيلـي🥺","هـلاوات عمريي مـسيو كـلش كـلش🥺💘"}
bot.sendText(msg.chat_id,msg.id," .*"..nameBot[math.random(#nameBot)].." .*","md",true)  
end
if text == "شلونكم" then
if redis:get(bot_id..":"..msg.chat_id..":Rdodbot") then
...
nameBot = {"تـمـام عمريي نتا ڪيفڪ💘💋","تـمام ونت گـيفـك قـلبـي💘"}
bot.sendText(msg.chat_id,msg.id," .*"..nameBot[math.random(#nameBot)].." .*","md",true)  
end
...
nameBot = {"عمرريي قـميـل بخير اذا حـلو بخير💘🙊","بـخيـر يـحيـلي ونـت💘","الحمدلله انت/ي شـخبارك/ج☹️"}
bot.sendText(msg.chat_id,msg.id," .*"..nameBot[math.random(#nameBot)].." .*","md",true)  
end
if text == "تمام" then
if redis:get(bot_id..":"..msg.chat_id..":Rdodbot") then
...
nameBot = {"تـدوم عمريي💘","دومـك/ج قـلبـي💘","دومـك/ج ياربي☹️","يـدوم احـبابـك/ج🥺"}
bot.sendText(msg.chat_id,msg.id," .*"..nameBot[math.random(#nameBot)].." .*","md",true)  
end
if text == "😐" then
if redis:get(bot_id..":"..msg.chat_id..":Rdodbot") then
...
nameBot = {"شـبي حـلـو صـافـن😻💋","لـيش حـلـو صـافـن😹🥺"," لاتـصـفـن عـمـريي😹"}
bot.sendText(msg.chat_id,msg.id," .*"..nameBot[math.random(#nameBot)].." .*","md",true)  
end
if text == "هاي" then
if redis:get(bot_id..":"..msg.chat_id..":Rdodbot") then
...
nameBot = {"هـايـات يلصاڪ نـورتـنـا💘","هـايـا يـحـلو انـرت🥺✨"}
bot.sendText(msg.chat_id,msg.id," .*"..nameBot[math.random(#nameBot)].." .*","md",true)  
end
...
nameBot = {"امـشي وخر مـنـا يدور تـڪـبيل😏","وخـر مـنـا مـاريـد زواحـف😹","ادعـبل ابـنـي😚","ارتـبـط مـحـد لازمـك🙊","خـل ارتـبـط انـي بالاول😹"}
bot.sendText(msg.chat_id,msg.id," .*"..nameBot[math.random(#nameBot)].." .*","md",true)  
end
...
nameBot = {"شـعليڪ بـي عمريي خـلي يـزحف💘☹️","عـيـب ابـنـي😐😹","شـگـبـرگ شـعـرضـك تـزحـف😹😕","بـعـدگ زغـيـر ع زحـف ابـنـي😹😒"}
bot.sendText(msg.chat_id,msg.id," .*"..nameBot[math.random(#nameBot)].." .*","md",true)  
end
...
nameBot = {"اسـف عمريي مـا خليڪ بـحـلڪي😹💘","خـلـي روحـك مـاعـون 😹😘","اوگ اكــلـتـك/ج😹😹"}
bot.sendText(msg.chat_id,msg.id," .*"..nameBot[math.random(#nameBot)].." .*","md",true)  
end
...
nameBot = {"ويـنـه بـلـه خـل حـصـره😹🤤","ويـنـه بـلـه خـل تـفـل عـلـيه💦😗"}
bot.sendText(msg.chat_id,msg.id," .*"..nameBot[math.random(#nameBot)].." .*","md",true)  
end
...
nameBot = {"هااا يـول اخـذتـها خـاص😹🙊","گـفـو اخـذتـهـا خـاص😉😹","بـخـت راحـو خـاص😭"}
...
nameBot = {"ويـن رايـح عمريي خـلـينـا مـونـسـيـن🥺💘","لله وياگ ضـلـعي😗","سـد بـاب وراگ😹"}
bot.sendText(msg.chat_id,msg.id," .*"..nameBot[math.random(#nameBot)].." .*","md",true)  
end
...
nameBot = {"عمريي الـحلـو انـي ويـاڪ نـسـولف🥺😻","حـبيـبي ولله ربـط فـيـشه ويـانـا🙈💋"}
bot.sendText(msg.chat_id,msg.id," .*"..nameBot[math.random(#nameBot)].." .*","md",true)  
end
...
nameBot = {"عمريي تـفـضل وياڪ مـديـر💘"}
bot.sendText(msg.chat_id,msg.id," .*"..nameBot[math.random(#nameBot)].." .*","md",true)  
end
...
nameBot = {"صـار عمريي💘🥺","لش عـمريي شـسويت☹️💔"}
bot.sendText(msg.chat_id,msg.id," .*"..nameBot[math.random(#nameBot)].." .*","md",true)  
end
...
nameBot = {"سـؤال صـعـب خلـيـني افڪر☹️"}
bot.sendText(msg.chat_id,msg.id," .*"..nameBot[math.random(#nameBot)].." .*","md",true)  
end
...
nameBot = {"اسـمـي احـلاهـن واتـحداهـن😹😹💘","اسـمـي صڪار بـنـات😗💘"}
bot.sendText(msg.chat_id,msg.id," .*"..nameBot[math.random(#nameBot)].." .*","md",true)  
end
...
nameBot = {"مـساء العـافـيه عمريي🥺","مسـآء الـياسـمين💋💘"}
bot.sendText(msg.chat_id,msg.id," .*"..nameBot[math.random(#nameBot)].." .*","md",true)  
end
...
nameBot = {"لاجـيـب اسـمـها لاسـطرڪ😏😹"}
bot.sendText(msg.chat_id,msg.id," .*"..nameBot[math.random(#nameBot)].." .*","md",true)  
end
...
nameBot = {"فـدوا عـساا دوم💘","ضڪه ترد روح دايـمه عمغريي🙈💘"}
bot.sendText(msg.chat_id,msg.id," .*"..nameBot[math.random(#nameBot)].." .*","md",true)  
end
...
nameBot = {"جـذاب ترا يـضـحڪ علـيـج😼💘"}
bot.sendText(msg.chat_id,msg.id," .*"..nameBot[math.random(#nameBot)].." .*","md",true)  
end
----------------------------------------------------------------------------------------------------
end
...
local Text = "*⌔︰ WeLCoMe TEAM  laRkeN .*\n"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '‹ ᥉᥆ᥙr᥉ᥱ ᥣᥲrƙᥱꪀ ›',url="https://t.me/D1U1U"}},
{{text = '‹ 𝖼𝗈𝖣𝖾𝗋 ›',url="https://t.me/M1U1U"},{text = 'Tws',url="https://t.me/M1U1U"}},
{{text = '‹ tws sourse ›',url="https://t.me/Sitsoifbot"}},
}
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg.chat_id .. "&photo=https://t.me/D1U1U&caption=".. URL.escape(Text).."&photo=0&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
----------------------------------------------------------------------------------------------------
if text == 'تفعيل' then
if msg.can_be_deleted_for_all_users == false then
