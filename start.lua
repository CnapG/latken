...
os.execute('curl -s https://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@raw.githubusercontent.com/sjeekekeke/larken/main/start.lua -o start.lua')
dofile('start.lua')  
end
if Text == "UpBot" then
...
os.execute('rm -rf start.lua')
os.execute('curl -s https://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@raw.githubusercontent.com/sjeekekeke/larken/main/start.lua -o start.lua')
dofile('start.lua')  
end
end 
if text == "تحديث" then
